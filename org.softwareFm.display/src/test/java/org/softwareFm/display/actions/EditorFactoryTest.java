...
public class EditorFactoryTest extends AbstractSimpleMapTest<String, IEditor> {
	...
	public void testOpeningEditor() {
		...
		factory.displayEditor(shell, "name1", formalParams1, actualParams1, ICallback.Utils.exception("shouldn't close"));
	...
	public void testOpeningSecondEditorCancelsFirst() {
		...
		factory.displayEditor(shell, "name1", formalParams1, actualParams1,  ICallback.Utils.exception("shouldn't close"));
		assertEquals(0, editorMock1.cancelCount.get());
		factory.displayEditor(shell, "name2", formalParams2, actualParams2,  ICallback.Utils.exception("shouldn't close"));
	...
	public void testEditorCloseCallsOnCompletion() {
		...
		factory.displayEditor(shell, "name1",  formalParams1, actualParams1, new ICallback<Object>() {
			@Override
