...
//		assertEquals(Arrays.asList(Arrays.asList(1)), actionMock.actualParams);
	...
	public void testTooltipsAreSetWithData() {
		...
		IDataGetter dataGetter = new DataGetterMock(//
				...
				"dataKey", "value1");
		ActionContext actionContext = new ActionContext(actionStore, dataGetter, null, null, null, null, null, null);
	...
	protected void setUp() throws Exception {
		...
		actionContext = new ActionContext(actionStore, new DataGetterMock("a", 1), new CompositeConfig(shell.getDisplay(), new SoftwareFmLayout(), imageRegistry, resourceGetter), null, null, null, null, null);
