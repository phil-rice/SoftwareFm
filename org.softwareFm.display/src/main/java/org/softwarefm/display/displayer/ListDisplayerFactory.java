...
public class ListDisplayerFactory implements IDisplayerFactory {
	...
	@Override
	public IDisplayer create(Composite composite, DisplayerDefn defn, int style, CompositeConfig compositeConfig) {
		return new ListDisplayer(composite, defn, style, compositeConfig);
	}
