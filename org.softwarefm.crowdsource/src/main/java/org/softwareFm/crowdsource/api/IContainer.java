...
public interface IContainer {
	...
	<Result, API> ITransaction<Result> access(Class<API> clazz, IFunction1<API, Result> function, ICallback<Result> resultCallback);

	<Result, A1, A2> ITransaction<Result> access(Class<A1> clazz1, Class<A2> clazz2, IFunction2<A1, A2, Result> function, ICallback<Result> resultCallback);

	<Result, A1, A2, A3> ITransaction<Result> access(Class<A1> clazz1, Class<A2> clazz2, Class<A3> clazz3, IFunction3<A1, A2, A3, Result> function, ICallback<Result> resultCallback);
