...
public class UserSourceType implements ISourceType {
	...
	@Override
	public List<ISingleSource> makeSourcesFor(IRepoReader reader, String rl, String file, String userId, String userCrypto, String cryptoKey) {
		...
		String crypto = IRepoReader.Utils.readPropertyFromFirstLine(reader, new EncryptedSingleSource(baseDataRl, userCrypto), cryptoKey);
		if (crypto == null)
