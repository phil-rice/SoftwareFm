...
public interface IUsageReader {
	...
	public static class Utils {
		public static IUsageReader localUsageReader(IContainer container, IUrlGenerator userUrlGenerator) {
			return new UsageReaderForLocal(container, userUrlGenerator);
		}
	}
