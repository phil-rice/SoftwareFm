...
import org.softwareFm.configuration.editor.JavadocSourceUrlTester;
...
public class EditorFactoryConfigurator implements IEditorFactoryConfigurator {
	...
	public void process(IEditorFactory editorFactory) throws Exception {
		JavadocSourceUrlTester tester = new JavadocSourceUrlTester();
		...
		editorFactory.register("editor.javadoc", new JavadocSourceEditor(//
				ConfigurationConstants.urlJavadocTitle, ConfigurationConstants.dataArtifactJavadoc, ConfigurationConstants.dataRawJavadoc, ConfigurationConstants.dataRawJavadocMutator));
		editorFactory.register("editor.source", new JavadocSourceEditor(//
				ConfigurationConstants.urlSourceTitle, ConfigurationConstants.dataArtifactSource, ConfigurationConstants.dataRawSource, ConfigurationConstants.dataRawSourceMutator));
