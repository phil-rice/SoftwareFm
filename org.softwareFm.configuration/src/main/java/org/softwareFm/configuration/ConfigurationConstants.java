...
public class ConfigurationConstants {
	...
	public static final String artifactIdMissingTitle = "artifact.artifactId.missing.title";
	public static final String artifactNameMissingTitle = "artifact.name.missing.title";
	public static final String groupIdMissingTitle = "artifact.groupId.missing.title";
