...
public class UtilityMessages {
	...
	public static final String httpValidationNull = "The {0} is null";
	public static final String clientValidationException = "{0}";
	public static final String elementMissingInDigestPage = "Element missing in digest page";
	public static final String tooManyElementsInDigestPage = "Too many elements in digest page {0}";
}