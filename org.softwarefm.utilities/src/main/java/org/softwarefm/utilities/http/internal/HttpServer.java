...
public class HttpServer implements IHttpServer {
	...
	public HttpServer(int noOfThreads, HttpParams httpParams, int port, HttpRequestHandler handler, final ICallback<Throwable> exceptionHandler) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.softwarefm.eclipse.usage.IUsageServer#start()
	 */
	public void start() {
		try {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		HttpServer httpServer = (HttpServer) IHttpServer.Utils.server(10, IHttpServer.Utils.simpleParams("Hello World"), port, IHttpServer.Utils.helloWorldHandler(), ICallback.Utils.sysErrCallback());
		httpServer.start();
		while (true) {
			Thread.sleep(20000);
