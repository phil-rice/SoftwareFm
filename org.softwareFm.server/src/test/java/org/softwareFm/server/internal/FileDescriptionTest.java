...
public class FileDescriptionTest extends GitTest {
	...
	public void testFindRepositoryUrl() {
		assertNull(fileDescription.findRepositoryUrl(root));
		IGitFacard.Utils.makeFacard().createRepository(root, "repo");
		assertEquals(new File(root, "repo"), fileDescription.findRepositoryUrl(root));
	}
