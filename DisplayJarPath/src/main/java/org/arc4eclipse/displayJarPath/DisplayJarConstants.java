...
public class DisplayJarConstants {
	...
	public static final String project = "jar.project";
	public static final String path = "jar.path";
	public static final String name = "jar.name";
	public static final String digest = "jar.digest";
	public static final String url = "jar.url";
