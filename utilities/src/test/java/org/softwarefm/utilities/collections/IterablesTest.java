...
public class IterablesTest extends TestCase {
	...
	public void testTail() {
		assertEquals(Arrays.asList(2, 3), Iterables.list(Iterables.tail(Arrays.asList(1, 2, 3))));
		assertEquals(Arrays.asList(), Iterables.list(Iterables.tail(Arrays.asList(1))));
	}
