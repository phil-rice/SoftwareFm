...
import org.arc4eclipse.debugMessagePanel.Activator;
...
public class DebugMessageView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		new DebugMessagePanel(parent, SWT.NULL, Activator.getDefault().getRepository(), Activator.getDefault().getSelectedBindingManager());
	}
