...
public class DebugBindingPanel extends Composite implements ISelectedBindingListener {
	...
	public DebugBindingPanel(Composite parent, int style, Images images, ISelectedBindingManager selectedBindingManager) {
		super(parent, style);
		setLayout(new FormLayout());

		titleAndStyledTextField = new TitleAndStyledTextField(this, SWT.NONE, images, "Binding");
