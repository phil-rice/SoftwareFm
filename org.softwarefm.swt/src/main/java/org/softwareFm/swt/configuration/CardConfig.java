...
package org.softwareFm.swt.configuration;
...
public class CardConfig {
	...
	/** The {@link org.softwareFm.swt.card.internal.Card.CardLayout} uses this to determine how wide to display the name column. The bigger the more space it takes up */
	public final int cardNameWeight = 8;
	/** The {@link org.softwareFm.swt.card.internal.Card.CardLayout} uses this to determine how wide to display the value column. The bigger the more space it takes up */
	public final int cardValueWeight = 8;
	/** The {@link org.softwareFm.swt.card.internal.Card.CardLayout} uses this to determine how wide to display the name column. Once the name column is 'this' much bigger than the ideal name width, it stops getting bigger */
	...
	public final IFunction1<ICard, String> popupMenuIdFn;
	...
	public CardConfig withCardDataModifiers(ICardDataModifier... keyValueModifiers) {
		return new CardConfig(resourceGetterFn, detailFactory, cardFactory, cardDataStore, cardStyle, allowSelection, cardTitleFn, imageFn, iconFn, nameFn, valueFn, defaultChildFn, hideFn, leftMargin, rightMargin, topMargin, bottomMargin, titleHeight, navIconFn, Arrays.asList(keyValueModifiers), titleSpecFn, rightClickCategoriser, urlGeneratorMap, editorFn, popupMenuService, popupMenuIdFn);
	}
