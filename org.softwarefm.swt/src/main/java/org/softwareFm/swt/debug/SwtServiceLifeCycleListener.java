...
public class SwtServiceLifeCycleListener implements IHasComposite, IServiceExecutorLifeCycleListener {
	...
	public static void main(String[] args) {
		...
		final IServiceExecutor executor = IServiceExecutor.Utils.defaultExecutor(SwtServiceLifeCycleListener.class.getSimpleName() + "-{0}", CommonConstants.threadPoolSizeForTests);
		try {
