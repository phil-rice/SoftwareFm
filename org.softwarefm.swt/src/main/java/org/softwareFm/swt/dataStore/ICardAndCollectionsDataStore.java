...
public interface ICardAndCollectionsDataStore {
	...
	ITransaction<ICard> processDataFor(IContainer container, final ICardHolder cardHolder, final CardConfig cardConfig, final String url, ICardAndCollectionDataStoreVisitor whenFinished);
}