...
public class CardConfig {
	...
	public CardConfig(ICardFactory cardFactory, ICardDataStore cardDataStore) {
		this.resourceGetter = IResourceGetter.Utils.noResources();
		...
		this.nameFn = Functions.identity();
		this.valueFn = Functions.toStringFn();
		this.hideFn = Functions.constant(false);
		
	}

	private CardConfig(IResourceGetter resourceGetter, ICardConfigSelector selector,  IDetailFactory detailFactory, ICardFactory cardFactory, ICardDataStore cardDataStore, int style, boolean allowSelection, IFunction1<Map<String, Object>, Image> cardIconFn, IFunction1<String, String> cardTitleFn, IFunction1<KeyValue, Image> iconFn, IFunction1<KeyValue, String> nameFn, IFunction1<KeyValue, String> valueFn, IFunction1<KeyValue, Boolean> hideFn) {
	...
	public CardConfig withTitleFn(IFunction1<String, String> urlToTitle) {
		return new CardConfig(resourceGetter, selector, detailFactory, cardFactory, cardDataStore, style, allowSelection, cardIconFn, urlToTitle, iconFn, nameFn, valueFn, hideFn);
