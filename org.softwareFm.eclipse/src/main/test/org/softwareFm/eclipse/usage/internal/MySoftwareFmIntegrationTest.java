...
public class MySoftwareFmIntegrationTest extends SwtAndServiceTest implements IIntegrationTest {
	...
	protected void setUp() throws Exception {
		...
		ProcessCallParameters processCallParameters = new ProcessCallParameters(dataSource, remoteOperations, cryptoGenerator, softwareFmIdGenerator, IMailer.Utils.noMailer());
