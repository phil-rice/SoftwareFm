...
public class Neo4SfmConstants {

	public static final String groupIdProperty = "groupId";
	public static final String artifactIdProperty = "artifactId";
	...
	public static final String groupArtifactIdIndexName = "groupArtifactId";
